...
const materialLineSchema = new mongoose.Schema(
  {
    ...
    chargedUnitPriceSyp: { type: Number, default: 0 },
    lineChargeSyp: { type: Number, default: 0 },
  },
  { _id: false },
)
...
const clinicalSessionSchema = new mongoose.Schema(
  {
    ...
    materialCostSypTotal: { type: Number, default: 0 },
    materialChargeSypTotal: { type: Number, default: 0 },
