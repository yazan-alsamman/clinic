...
function billingItemDto(b, patientName, providerName, usdSypBusinessDayRate = null, patientBalances = null) {
  const patientIdRaw =
  ...
  return {
    ...
    effectiveAmountDueSyp: effectiveDue,
