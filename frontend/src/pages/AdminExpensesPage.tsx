  ...
  return (
    <>
      ...
      <p className="page-desc">
        سجلات مصاريف الأقسام. يمكن إدخال المبلغ بالليرة السورية أو بالدولار (أو الاثنين معاً). دولار يُحوَّل للتقارير
        بسعر صرف يوم العمل
        {usdSypRate != null ? ` (حالياً ${usdSypRate.toLocaleString('ar-SY')} ل.س)` : ''}. رواتب الموظفين تُدار من
        صفحة «الرواتب».
      </p>
